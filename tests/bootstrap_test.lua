...
assert(mod.exports.algorithmVersion == "1.16.0-dev")
...
assert(#mod.exports.preferences.schema() == 55)
...
assert(migrations[4].since == "0.44.0")
...
save.meta.mods = {
  { id = "pokemon_randomizer", version = "0.44.0", api = 2 },
